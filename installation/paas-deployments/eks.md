...
* Install [helm](https://docs.helm.sh/using\_helm/#installing-helm)
...
So we need to install service account to allow helm to operate correctly. [More info about that here](https://docs.helm.sh/using\_helm/#example-service-account-with-cluster-admin-role)
...
* [Rocket.Chat Community](https://aws.amazon.com/marketplace/pp/B07K9BKJHP?qid=1549500780099\&sr=0-1\&ref\_=srh\_res\_product\_title)
* [Rocket.Chat Enterprise](https://aws.amazon.com/marketplace/pp/B07K98179S?qid=1549500780099\&sr=0-3\&ref\_=srh\_res\_product\_title)
